...
namespace ZenTimings.Windows
{
    ...
    public partial class DebugDialog : Window
    {
        ...
        private void SaveToFile(bool saveAs = false)
        {
            ...
            MessageBox.Show($"Debug report saved as {filename}", saveAs ? "Save As" : "Save", MessageBoxButton.OK);
        }

        private void ButtonDebug_Click(object sender, RoutedEventArgs e) => Debug();
